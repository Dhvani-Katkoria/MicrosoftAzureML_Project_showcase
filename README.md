...
## Dataset: 
**Kitti Road/Lane Detection Evaluation 2013:** dataset is used for road segmentation. The dataset consists of 289 training and 290 test images. It contains three different categories of road scenes:
